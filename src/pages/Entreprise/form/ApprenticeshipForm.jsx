  ...
  return (
    <form onSubmit={handleSubmit}>
      <section>
        <h1>APPRENTI(E)</h1>
        <div>
          <label>APPRENTI(E) ESEO (NOM)*</label>
        ...
        <div>
          <label>APPRENTI(E) ESEO (Prénom) *</label>
        ...
        <div>
          <label>INTITULÉ DU POSTE OCCUPÉ PAR L’APPRENTI(E) : * </label>
          <input type="text" name="apprenticePostName" value={formData.apprenticePostName} onChange={handleChange} required/>
        </div>

        <div>
          <label>DESCRIPTIF DU POSTE : fiche de poste détaillée des missions confiées dans le cadre du contrat d'apprentissage : * </label>
        ...
        <div>
          <label>CLASSIFICATION DANS LA CONVENTION COLLECTIVE (Niveaux et coefficients hiérarchiques) : * </label>
        ...
        <div>
          ...
          <div>
            ...
            {['35', '39'].includes(formData.workHours) || (
              <div>
                <label>Indiquez le nombre d'heures :</label>
                <input
                  type="text"
                  name="workHours"
      ...
      <section>
        ...
        <div>
          <label>SECTEUR ACTIVITÉ PRINCIPALE : *</label>
        ...
        <div>
          <label>ADRESSE (ADRESSE - CP - VILLE) : *</label>
        ...
        <div>
          <label>LIEU DE FORMATION (RAISON SOCIALE) :</label>
        ...
        <div>
          <label>LIEU DE FORMATION (SIRET) :</label>
        ...
        <div>
          <label>LIEU DE FORMATION (ADRESSE - CP - VILLE) :</label>
        ...
        <div>
          <label>OPCO (NOM - RAISON SOCIALE) : *</label>
        ...
        <div>
          <label>OPCO (ADRESSE - CP - VILLE) : *</label>
      ...
      <section>
        ...
        <div>
          <label>REPRÉSENTANT DE L'ENTREPRISE (NOM) : * </label>
        ...
        <div>
          <label>REPRÉSENTANT DE L'ENTREPRISE (Prénom) : *</label>
        ...
        <div>
          <label>REPRÉSENTANT DE L'ENTREPRISE (Fonction) : *</label>
        ...
        <div>
          <label>REPRÉSENTANT DE L'ENTREPRISE (Téléphone) *</label>
      ...
      <div>
      <label>LE REPRESENTANT DE L'ENTREPRISE EST-IL UN ANCIEN DE L'ESEO ? *</label>
        <div>
      ...
      <div>
        <label>MAÎTRE D'APPRENTISSAGE (NOM) *</label>
      ...
      <div>
        <label>MAÎTRE D'APPRENTISSAGE (PRENOM) *</label>
      ...
      <div>
        <label>MAÎTRE D'APPRENTISSAGE (Téléphone) *</label>
      ...
      <div>
        <label>MAÎTRE D'APPRENTISSAGE (E-mail) *</label>
      ...
      <div>
        <label>MAÎTRE D'APPRENTISSAGE (Fonction) *</label>
      ...
      <div>
        <label>MAÎTRE D'APPRENTISSAGE (Dernier diplôme obtenu) *</label>
      ...
      <div>
        <label>LE MAÎTRE D'APPRENTISSAGE DE L'APPRENTI EST-IL UN ANCIEN DE L'ESEO ? *</label>
        <div>
      ...
      <div>
        <label>RESPONSABLE FINANCE/COMPTABILITÉ (NOM) *</label>
      ...
      <div>
        <label>RESPONSABLE FINANCE/COMPTABILITÉ (Prénom) *</label>
      ...
      <div>
        <label>RESPONSABLE FINANCE/COMPTABILITÉ (Téléphone) *</label>
      ...
      <div>
        <label>RESPONSABLE FINANCE/COMPTABILITÉ (E-mail) *</label>
      ...
      <div>
        <label>LE RESPONSABLE FINANCE/COMPTABILITÉ EST-IL UN ANCIEN DE L'ESEO ? *</label>
        <div>
      ...
      <div>
        <label>SUIVI ADMINISTRATIF DU DOSSIER (NOM) *</label>
      ...
      <div>
        <label>SUIVI ADMINISTRATIF DU DOSSIER (Prénom) *</label>
      ...
      <div>
        <label>SUIVI ADMINISTRATIF DU DOSSIER (Téléphone) *</label>
      ...
      <div>
        <label>SUIVI ADMINISTRATIF DU DOSSIER (E-mail) *</label>
      ...
      <div>
        <label>LE RESPONSABLE DU SUIVI ADMINISTRATIF DU DOSSIER EST-IL UN ANCIEN DE L'ESEO ? *</label>
        <div>
      ...
      <div>
        <label>Rappel concernant l'Expérience Internationale exigée par la CTI *</label>
